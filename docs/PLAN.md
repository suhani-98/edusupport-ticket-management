...
Ticket create, list, detail, assignment, status, priority, comments, resolve, close, reopen, and activity history are implemented. Dashboards, automatic escalation, and ticket screens are not.
