...
Ticket APIs, explicit SLA refresh, manual escalation, activity history, role dashboard APIs, the sign-in shell, and the student ticket experience are implemented. Staff UI, manager UI, dashboard charts, notifications, and automatic SLA monitoring are not.
