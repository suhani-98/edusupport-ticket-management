        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-3 px-4 py-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
          <div className="flex min-w-0 flex-1 flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
            <div className="flex items-center gap-3">
              <span className="grid h-9 w-9 shrink-0 place-items-center rounded-md bg-teal-800 text-sm font-bold text-white" aria-hidden="true">
                E
              </span>
              <div>
                <p className="text-sm font-semibold leading-tight">EduSupport</p>
                <p className="text-xs text-slate-500">{user ? roleLabels[user.role] : "Student support desk"}</p>
              </div>
            </div>
